...
class MongoController {
  constructor() {
    ...
    if (process.env.LINTO_STACK_MONGO_USE_LOGIN === 'true')
      urlMongo += process.env.LINTO_STACK_MONGO_USER + ':' + process.env.LINTO_STACK_MONGO_PASSWORD + '@'
    urlMongo += process.env.LINTO_STACK_MONGO_HOST + ':' + process.env.LINTO_STACK_MONGO_PORT + '/' + process.env.LINTO_STACK_MONGO_DB_NAME

    if (process.env.LINTO_STACK_MONGO_USE_LOGIN === 'true')
      urlMongo += '?authSource=' + process.env.LINTO_STACK_MONGO_DB_NAME
  ...
  async init(urlMongo) {
    ...
    this.clientDb = await this.client.db(process.env.LINTO_STACK_MONGO_DB_NAME)
  ...
  update(dataLintos, dataLog) {
    ...
    try {
      this.clientDb.collection(process.env.LINTO_STACK_MONGO_COLLECTION_LINTOS).updateOne({
      ...
      this.clientDb.collection(process.env.LINTO_STACK_MONGO_COLLECTION_LOG).insertOne({
